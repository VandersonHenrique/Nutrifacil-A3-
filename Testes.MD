...
|:----------|:-----------------------------:|-------------:|-------------:|-----------------:|-------------------:|-----------------:|----------------:|------------:|
| FT-01     | Seleção de Dieta Vegetariana | Usuário autenticado e página de “Seleção de Dieta” aberta | 1. Acessar a tela de seleção de dieta 2. Selecionar a opção “Vegetariana” 3. Preencher o campo Peso com 100 kg 4. Preencher o campo Altura com 182 cm 5. Preencher o campo Idade com 40 anos 6. Selecionar Sexo como Masculino 7. Clicar no botão “Gerar Dieta” | Dieta: Vegetariana - Peso: 100 - Altura: 182 - Idade: 40 - Objetivo: Emagrecimento | O sistema exibe um plano alimentar contendo refeições ricas em lentilhas com foco em vegetais não amilácios com variedade de folhas verdes, arroz integral e batata doce.|  O sistema exibe um plano alimentar contendo refeições ricas em lentilhas com foco em vegetais não amilácios com variedade de folhas verdes, arroz integral e batata doce. |  ✅  |  O sistema respondeu como o esperado  |

| ID        | Funcionalidade                | Pré-Condição | Passos       | Dados de Entrada | Resultado Esperado | Resultado Obtido | Status (✅/❌) | Observações |
|:----------|:-----------------------------:|-------------:|-------------:|-----------------:|-------------------:|-----------------:|----------------:|------------:|
| FT-02     | Seleção de Dieta Mediterrânea | Usuário autenticado e página de “Seleção de Dieta” aberta | 1. Acessar a tela de seleção de dieta 2. Selecionar a opção “Mediterrânea” 3. Preencher o campo Peso com 60 kg 4. Preencher o campo Altura com 155 cm 5. Preencher o campo Idade com 22 anos 6. Selecionar Sexo como Feminino 7. Clicar no botão “Gerar Dieta” | Dieta: Mediterrânea - Peso: 60 - Altura: 155 - Idade: 40 - Objetivo: Emagrecimento | O sistema exibe um plano alimentar contendo refeições ricas em Peixes, Frango, Ovos, Tomate, Pimentão, Espinafre, Brocolis e Frutas.|  O sistema exibe um plano alimentar contendo refeições ricas em Peixes, Frango, Ovos, Tomate, Pimentão, Espinafre, Brocolis e Frutas. |  ✅  |  O sistema respondeu como o esperado  |
